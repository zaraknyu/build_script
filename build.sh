...
git clone https://github.com/zarakinyu-playground/android_device_xiaomi_warm device/xiaomi/warm
git clone https://github.com/zarakinyu-playground/android_vendor_xiaomi_warm vendor/xiaomi/warm
